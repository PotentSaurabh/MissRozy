...
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002118003102")).split())) 
STREAM_LOGS = environ.get('STREAM_LOGS','-1002080749453')
SESSION = environ.get('SESSION','Heaven')
...
class Config(object):
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001166808004")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002025062228")
	BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "1833282187").split())
	FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", True))
	BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", False))
	LAZY_CHANNEL = int(os.environ.get('LAZY_CHANNEL','-100'))
	LAZY_MODE = bool(os.environ.get("LAZY_MODE", False))
	LAZY_PIC = os.environ.get("LAZY_PIC","https://telegra.ph/file/06a979bb8eb5153e7e035.jpg")
  ...
  # LP_CUSTOM_TEMPLATE= os.environ.get("LP_CUSTOM_TEMPLATE","{file_name} - example \n\n Please Upadate this template acording to you @LazyDeveloperr ")
	BANNED_CHAT_IDS = list(set(int(x) for x in os.environ.get("BANNED_CHAT_IDS", "-1001576128100").split()))
...
🧑🏻‍💻 **DΞVΞLФPΞЯ:** [HeavenForYouAll](https://t.me/HeavenForYouAll)

👥 **šupp⊕r† gr⊕up:** [SupP⊕ЯΓ](https://t.me/HeavensChat)

📢 **U͢p͢d͢a͢t͢e͢s͢ C͢h͢a͢n͢n͢e͢l͢:** [HeavenForYouAll](https://t.me/HeavenForYouAll)
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 <a href='https://t.me/HeavenForYouAll'>**ミ★- ʜᴇᴀᴠᴇɴꜰᴏʀʏᴏᴜᴀʟʟ -★彡** </a>

<a href=''https://t.me/HeavenForYouAll>ʜᴇᴀᴠᴇɴꜰᴏʀʏᴏᴜᴀʟʟ</a> ɪꜱ ꜱᴜᴘᴇʀ ɴᴏᴏʙ 😎. ᴊᴜꜱᴛ ʟᴇᴀʀɴɪɴɢ ꜰʀᴏᴍ ᴏꜰꜰɪᴄɪᴀʟ ᴅᴏᴄꜱ. ᴘʟᴇᴀꜱᴇ ᴅᴏɴᴀᴛᴇ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ꜰᴏʀ ᴋᴇᴇᴘɪɴɢ ᴛʜᴇ ꜱᴇʀᴠɪᴄᴇ ᴀʟɪᴠᴇ.
ᴀʟꜱᴏ ʀᴇᴍᴇᴍʙᴇʀ ᴛʜᴀᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴡɪʟʟ ᴅᴇʟᴇᴛᴇ ᴀᴅᴜʟᴛ ᴄᴏɴᴛᴇɴᴛꜱ ꜰʀᴏᴍ ᴅᴀᴛᴀʙᴀꜱᴇ. ꜱᴏ ʙᴇᴛᴛᴇʀ ᴅᴏɴ'ᴛ ꜱᴛᴏʀᴇ ᴛʜᴏꜱᴇ ᴋɪɴᴅ ᴏꜰ ᴛʜɪɴɢꜱ.
[Donate Now] (https://telegra.ph/file/5b2e449d1901de6e91a7b.jpg) (UPI)
"""
	LAZY_HOME_TEXT = """
